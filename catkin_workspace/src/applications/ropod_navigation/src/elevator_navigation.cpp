...
/*--------------------------------------------------------*/
bool Elevator_navigation::check_door(ropod_navigation::doorDetection doorStatus) {    
...
task_fb_ccu Elevator_navigation::navigation_state_machine(ros::Publisher &movbase_cancel_pub, move_base_msgs::MoveBaseGoal* goal_ptr, 
						   bool& sendgoal, wm::Elevator elevator, ropod_navigation::doorDetection doorStatus) {
  task_fb_ccu tfb_nav;
