...
// Conversions between SL_Bus_ROPOD_4Wheel_TdistZMPC_cntr_geometry_msgs_Point and geometry_msgs::Point
...
// Conversions between SL_Bus_ROPOD_4Wheel_TdistZMPC_cntr_geometry_msgs_Pose and geometry_msgs::Pose
...
// Conversions between SL_Bus_ROPOD_4Wheel_TdistZMPC_cn_PoseWithCovariance_4e021t and geometry_msgs::PoseWithCovariance
...
// Conversions between SL_Bus_ROPOD_4Wheel_TdistZMPC_cntr_geometry_msgs_Quaternion and geometry_msgs::Quaternion
...
// Conversions between SL_Bus_ROPOD_4Wheel_TdistZMPC_cntr_geometry_msgs_Twist and geometry_msgs::Twist
...
// Conversions between SL_Bus_ROPOD_4Wheel_TdistZMPC_cn_TwistWithCovariance_thzi69 and geometry_msgs::TwistWithCovariance
...
// Conversions between SL_Bus_ROPOD_4Wheel_TdistZMPC_cntr_geometry_msgs_Vector3 and geometry_msgs::Vector3
...
// Conversions between SL_Bus_ROPOD_4Wheel_TdistZMPC_cntr_geometry_msgs_Wrench and geometry_msgs::Wrench
...
// Conversions between SL_Bus_ROPOD_4Wheel_TdistZMPC_cn_WrenchStamped_datn2q and geometry_msgs::WrenchStamped
...
{
  const std::string rosMessageType("geometry_msgs/WrenchStamped");

  convertFromBus(&msgPtr->header, &busPtr->Header);
  convertFromBus(&msgPtr->wrench, &busPtr->Wrench);
}
...
void convertToBus(SL_Bus_ROPOD_4Wheel_TdistZMPC_cn_WrenchStamped_datn2q* busPtr, geometry_msgs::WrenchStamped const* msgPtr)
{
  ...
  convertToBus(&busPtr->Wrench, &msgPtr->wrench);
}


// Conversions between SL_Bus_ROPOD_4Wheel_TdistZMPC_cntr_nav_msgs_Odometry and nav_msgs::Odometry
...
// Conversions between SL_Bus_ROPOD_4Wheel_TdistZMPC_cntr_ros_time_Time and ros::Time
...
// Conversions between SL_Bus_ROPOD_4Wheel_TdistZMPC_cntr_std_msgs_Bool and std_msgs::Bool
...
// Conversions between SL_Bus_ROPOD_4Wheel_TdistZMPC_cntr_std_msgs_Header and std_msgs::Header
...
// Conversions between SL_Bus_ROPOD_4Wheel_TdistZMPC_cntr_std_msgs_UInt16 and std_msgs::UInt16
