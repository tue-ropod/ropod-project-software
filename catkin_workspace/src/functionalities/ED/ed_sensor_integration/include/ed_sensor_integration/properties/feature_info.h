#ifndef ED_SENSOR_INTEGRATION_FEATURE_INFO_H_
#define ED_SENSOR_INTEGRATION_FEATURE_INFO_H_

#include <ed/property_info.h>

class FeatureInfo : public ed::PropertyInfo
{
...
//         return true;
    ...
    bool serializable() const { return false; }
