...
void ROPOD_4Wheel_kinb_cntr_step(void)
{
  ...
  ROPOD_4Wheel_kinb_cntr_B.Add[3] = ROPOD_4Wheel_kinb_cntr_P.Constant20_Value -
  ...
  ROPOD_4Wheel_kinb_cntr_B.timestamp =
  ...
  ROPOD_4Wheel_kinb_cntr_B.TmpSignalConversionAtSelect[7] =
    ...
    ROPOD_4Wheel_kinb_cntr_P.Constant17_Value;
  ...
  ROPOD_4Wheel_kinb_cntr_B.BusAssignment_h.Angular.Z =
    ROPOD_4Wheel_kinb_cntr_P.Constant5_Value_g;
  ...
  ROPOD_4Wheel_kinb_cntr_B.BusAssignment3.Linear.X =
    ROPOD_4Wheel_kinb_cntr_B.Product3[(int32_T)
    ROPOD_4Wheel_kinb_cntr_P.Constant9_Value + 6];
  ROPOD_4Wheel_kinb_cntr_B.BusAssignment3.Linear.Y =
    ROPOD_4Wheel_kinb_cntr_B.TmpSignalConversionAtSelect[(int32_T)
    ROPOD_4Wheel_kinb_cntr_P.Constant9_Value - 1];
  ...
  ROPOD_4Wheel_kinb_cntr_B.BusAssignment3.Angular.X =
    ROPOD_4Wheel_kinb_cntr_B.Product3[(int32_T)
    ROPOD_4Wheel_kinb_cntr_P.Constant10_Value + 6];
  ROPOD_4Wheel_kinb_cntr_B.BusAssignment3.Angular.Y =
    ROPOD_4Wheel_kinb_cntr_B.TmpSignalConversionAtSelect[(int32_T)
    ROPOD_4Wheel_kinb_cntr_P.Constant10_Value - 1];
  ROPOD_4Wheel_kinb_cntr_B.BusAssignment3.Angular.Z =
    ROPOD_4Wheel_kinb_cntr_P.Constant11_Value_p;
  ...
  ROPOD_4Wheel_kinb_cntr_B.BusAssignment7.Linear.Y =
    ROPOD_4Wheel_kinb_cntr_P.Constant6_Value_o;
  ROPOD_4Wheel_kinb_cntr_B.BusAssignment7.Linear.Z =
    ROPOD_4Wheel_kinb_cntr_P.Constant7_Value_k;
  ROPOD_4Wheel_kinb_cntr_B.BusAssignment7.Angular.X =
    ROPOD_4Wheel_kinb_cntr_P.Constant29_Value;
  ROPOD_4Wheel_kinb_cntr_B.BusAssignment7.Angular.Y =
    ROPOD_4Wheel_kinb_cntr_P.Constant24_Value;
  ROPOD_4Wheel_kinb_cntr_B.BusAssignment7.Angular.Z =
    ROPOD_4Wheel_kinb_cntr_P.Constant25_Value;
...
void ROPOD_4Wheel_kinb_cntr_initialize(void)
{
  ...
  ROPOD_4Wheel_kinb_cntr_M->Sizes.numSFcns = (4);
  ...
  // register each child
  {
    ...
    ROPOD_4Wheel_kinb_cntr_M->childSfunctions[0] =
      (&ROPOD_4Wheel_kinb_cntr_M->NonInlinedSFcns.childSFunctions[0]);
    ROPOD_4Wheel_kinb_cntr_M->childSfunctions[1] =
      (&ROPOD_4Wheel_kinb_cntr_M->NonInlinedSFcns.childSFunctions[1]);
    ROPOD_4Wheel_kinb_cntr_M->childSfunctions[2] =
      (&ROPOD_4Wheel_kinb_cntr_M->NonInlinedSFcns.childSFunctions[2]);
    ROPOD_4Wheel_kinb_cntr_M->childSfunctions[3] =
      (&ROPOD_4Wheel_kinb_cntr_M->NonInlinedSFcns.childSFunctions[3]);
