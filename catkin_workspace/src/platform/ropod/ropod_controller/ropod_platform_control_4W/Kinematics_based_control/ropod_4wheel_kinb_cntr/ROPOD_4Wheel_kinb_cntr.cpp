...
#define ParameterInitialValue_nc4bpmzds (0.2813)
...
#define R_ParameterInitialValue_nc4bpmz (0.147)
...
void ROPOD_4Wheel_kinb_cntr_step(void)
{
  ...
  // S-Function (ec_ROPOD_SmartWheel): '<S36>/S-Function'

  // Level2 S-Function Block: '<S36>/S-Function' (ec_ROPOD_SmartWheel)
  {
  ...
  if (ROPOD_4Wheel_kinb_cntr_M->Timing.TaskCounters.TID[2] == 0) {
    ...
    // DataTypeConversion: '<S28>/Data Type Conversion6' incorporates:
    ...
    // DataTypeConversion: '<S28>/Data Type Conversion7' incorporates:
    ...
    // S-Function (sfix_bitop): '<S28>/Bitwise Operator' incorporates:
  ...
  ROPOD_4Wheel_kinb_cntr_B.command2 = ROPOD_4Wheel_kinb_cntr_P.Constant_Value_n;
  ...
  if (ROPOD_4Wheel_kinb_cntr_M->Timing.TaskCounters.TID[1] == 0) {
    ...
    // Update for UnitDelay: '<S38>/Delay Input2'
    //
    //  Block description for '<S38>/Delay Input2':
    //
    //   Store in Global RAM
    ...
    // Update for UnitDelay: '<S39>/Delay Input2'
    //
    //  Block description for '<S39>/Delay Input2':
    //
    //   Store in Global RAM
...
void ROPOD_4Wheel_kinb_cntr_initialize(void)
{
  ...
  // register each child
  {
    ...
    // Level2 S-Function Block: ROPOD_4Wheel_kinb_cntr/<S33>/S-Function (ec_ROPOD_SmartWheel) 
    {
      SimStruct *rts = ROPOD_4Wheel_kinb_cntr_M->childSfunctions[1];
    ...
    // Level2 S-Function Block: ROPOD_4Wheel_kinb_cntr/<S34>/S-Function (ec_ROPOD_SmartWheel) 
    {
      SimStruct *rts = ROPOD_4Wheel_kinb_cntr_M->childSfunctions[2];
    ...
    // Level2 S-Function Block: ROPOD_4Wheel_kinb_cntr/<S35>/S-Function (ec_ROPOD_SmartWheel) 
    {
      SimStruct *rts = ROPOD_4Wheel_kinb_cntr_M->childSfunctions[3];
    ...
    // Level2 S-Function Block: ROPOD_4Wheel_kinb_cntr/<S36>/S-Function (ec_ROPOD_SmartWheel) 
    {
      SimStruct *rts = ROPOD_4Wheel_kinb_cntr_M->childSfunctions[4];
  ...
  {
    static const char_T tmp[10] = { '/', 'p', 'i', 'c', 'o', '/', 'o', 'd', 'o',
      'm' };

    static const char_T tmp_0[14] = { '/', 's', 'm', 'a', 'r', 't', 'w', '4',
      '_', 'd', 'e', 'b', 'u', 'g' };

    static const char_T tmp_1[14] = { '/', 's', 'm', 'a', 'r', 't', 'w', '3',
      '_', 'd', 'e', 'b', 'u', 'g' };

    static const char_T tmp_2[14] = { '/', 's', 'm', 'a', 'r', 't', 'w', '2',
      '_', 'd', 'e', 'b', 'u', 'g' };

    static const char_T tmp_3[14] = { '/', 's', 'm', 'a', 'r', 't', 'w', '1',
      '_', 'd', 'e', 'b', 'u', 'g' };

    static const char_T tmp_4[24] = { '/', 'b', 'a', 's', 'e', '_', 'c', 'o',
      'n', 'f', '/', 'm', 'a', 'x', '_', 'v', 'e', 'l', '_', 't', 'h', 'e', 't',
      'a' };

    static const char_T tmp_5[24] = { '/', 'b', 'a', 's', 'e', '_', 'c', 'o',
      'n', 'f', '/', 'm', 'a', 'x', '_', 'a', 'c', 'c', '_', 't', 'h', 'e', 't',
      'a' };

    static const char_T tmp_6[13] = { '/', 'p', 'i', 'c', 'o', '/', 'c', 'm',
      'd', '_', 'v', 'e', 'l' };

    static const char_T tmp_7[21] = { '/', 'b', 'a', 's', 'e', '_', 'c', 'o',
      'n', 'f', '/', 'm', 'a', 'x', '_', 'v', 'e', 'l', '_', 'x', 'y' };

    static const char_T tmp_8[21] = { '/', 'b', 'a', 's', 'e', '_', 'c', 'o',
      'n', 'f', '/', 'm', 'a', 'x', '_', 'a', 'c', 'c', '_', 'x', 'y' };

    static const char_T tmp_9[24] = { '/', 'b', 'a', 's', 'e', '_', 'k', 'i',
      'n', '_', 'm', 'o', 'd', 'e', 'l', '/', 'y', 'p', 'o', 's', '_', 'S', 'W',
      '4' };

    static const char_T tmp_a[24] = { '/', 'b', 'a', 's', 'e', '_', 'k', 'i',
      'n', '_', 'm', 'o', 'd', 'e', 'l', '/', 'x', 'p', 'o', 's', '_', 'S', 'W',
      '4' };

    static const char_T tmp_b[24] = { '/', 'b', 'a', 's', 'e', '_', 'k', 'i',
      'n', '_', 'm', 'o', 'd', 'e', 'l', '/', 'y', 'p', 'o', 's', '_', 'S', 'W',
      '3' };

    static const char_T tmp_c[24] = { '/', 'b', 'a', 's', 'e', '_', 'k', 'i',
      'n', '_', 'm', 'o', 'd', 'e', 'l', '/', 'x', 'p', 'o', 's', '_', 'S', 'W',
      '3' };
    ...
    static const char_T tmp_h[19] = { '/', 'b', 'a', 's', 'e', '_', 'k', 'i',
      'n', '_', 'm', 'o', 'd', 'e', 'l', '/', 'd', '_', 'w' };

    static const char_T tmp_i[19] = { '/', 'b', 'a', 's', 'e', '_', 'k', 'i',
      'n', '_', 'm', 'o', 'd', 'e', 'l', '/', 's', '_', 'w' };
    ...
    static const char_T tmp_l[24] = { '/', 'b', 'a', 's', 'e', '_', 'k', 'i',
      'n', '_', 'm', 'o', 'd', 'e', 'l', '/', 'r', '_', 'w', 'R', '_', 'S', 'W',
      '3' };

    static const char_T tmp_m[24] = { '/', 'b', 'a', 's', 'e', '_', 'k', 'i',
      'n', '_', 'm', 'o', 'd', 'e', 'l', '/', 'r', '_', 'w', 'L', '_', 'S', 'W',
      '3' };
    ...
    static const char_T tmp_r[25] = { '/', 's', 'm', 'a', 'r', 't', '_', 'w',
      'h', 'e', 'e', 'l', 's', '/', 'm', 'a', 'x', '_', 'c', 'u', 'r', 'r', 'e',
      'n', 't' };

    static const char_T tmp_s[20] = { '/', 's', 'm', 'a', 'r', 't', '_', 'w',
    ...
    for (i = 0; i < 28; i++) {
      ROPOD_4Wheel_kinb_cntr_B.cv0[i] = tmp_w[i];
    }
    ...
    for (i = 0; i < 28; i++) {
      ROPOD_4Wheel_kinb_cntr_B.cv0[i] = tmp_v[i];
    }
    ...
    for (i = 0; i < 28; i++) {
      ROPOD_4Wheel_kinb_cntr_B.cv0[i] = tmp_u[i];
    }
    ...
    for (i = 0; i < 28; i++) {
      ROPOD_4Wheel_kinb_cntr_B.cv0[i] = tmp_t[i];
    }
    ...
    for (i = 0; i < 20; i++) {
      ROPOD_4Wheel_kinb_cntr_B.cv4[i] = tmp_s[i];
    }

    ROPOD_4Wheel_kinb_cntr_B.cv4[20] = '\x00';
    ParamGet_ROPOD_4Wheel_kinb_cntr_542.initialize(ROPOD_4Wheel_kinb_cntr_B.cv4);
    ...
    for (i = 0; i < 25; i++) {
      ROPOD_4Wheel_kinb_cntr_B.cv1[i] = tmp_r[i];
    }
    ...
    for (i = 0; i < 24; i++) {
      ROPOD_4Wheel_kinb_cntr_B.cv2[i] = tmp_m[i];
    }
    ...
    for (i = 0; i < 24; i++) {
      ROPOD_4Wheel_kinb_cntr_B.cv2[i] = tmp_l[i];
    }
    ...
    tmp_10[19] = '\x00';
    ParamGet_ROPOD_4Wheel_kinb_cntr_1097.initialize(tmp_10);
    ...
    tmp_10[19] = '\x00';
    ParamGet_ROPOD_4Wheel_kinb_cntr_1098.initialize(tmp_10);
    ...
    for (i = 0; i < 24; i++) {
      ROPOD_4Wheel_kinb_cntr_B.cv2[i] = tmp_c[i];
    }
    ...
    for (i = 0; i < 24; i++) {
      ROPOD_4Wheel_kinb_cntr_B.cv2[i] = tmp_b[i];
    }
    ...
    for (i = 0; i < 24; i++) {
      ROPOD_4Wheel_kinb_cntr_B.cv2[i] = tmp_a[i];
    }
    ...
    for (i = 0; i < 21; i++) {
      ROPOD_4Wheel_kinb_cntr_B.cv3[i] = tmp_8[i];
    }

    ROPOD_4Wheel_kinb_cntr_B.cv3[21] = '\x00';
    ParamGet_ROPOD_4Wheel_kinb_cntr_551.initialize(ROPOD_4Wheel_kinb_cntr_B.cv3);
    ...
    for (i = 0; i < 21; i++) {
      ROPOD_4Wheel_kinb_cntr_B.cv3[i] = tmp_7[i];
    }

    ROPOD_4Wheel_kinb_cntr_B.cv3[21] = '\x00';
    ParamGet_ROPOD_4Wheel_kinb_cntr_552.initialize(ROPOD_4Wheel_kinb_cntr_B.cv3);
    ...
    tmp_z[13] = '\x00';
    Sub_ROPOD_4Wheel_kinb_cntr_528.createSubscriber(tmp_z,
    ...
    for (i = 0; i < 24; i++) {
      ROPOD_4Wheel_kinb_cntr_B.cv2[i] = tmp_5[i];
    }
    ...
    for (i = 0; i < 24; i++) {
      ROPOD_4Wheel_kinb_cntr_B.cv2[i] = tmp_4[i];
    }
    ...
    tmp_y[14] = '\x00';
    Pub_ROPOD_4Wheel_kinb_cntr_902.createPublisher(tmp_y,
    ...
    tmp_y[14] = '\x00';
    Pub_ROPOD_4Wheel_kinb_cntr_959.createPublisher(tmp_y,
      ROPOD_4Wheel_ki_MessageQueueLen);
    ...
    tmp_y[14] = '\x00';
    Pub_ROPOD_4Wheel_kinb_cntr_983.createPublisher(tmp_y,
      ROPOD_4Wheel_ki_MessageQueueLen);
    ...
    tmp_y[14] = '\x00';
    Pub_ROPOD_4Wheel_kinb_cntr_994.createPublisher(tmp_y,
      ROPOD_4Wheel_ki_MessageQueueLen);
    ...
    tmp_x[10] = '\x00';
    Pub_ROPOD_4Wheel_kinb_cntr_349.createPublisher(tmp_x,
      ROPOD_4Wheel_ki_MessageQueueLen);
    ...
    // InitializeConditions for UnitDelay: '<S38>/Delay Input2'
    //
    //  Block description for '<S38>/Delay Input2':
    //
    //   Store in Global RAM
    ...
    // InitializeConditions for UnitDelay: '<S39>/Delay Input2'
    //
    //  Block description for '<S39>/Delay Input2':
    //
    //   Store in Global RAM
    ...
    // InitializeConditions for UnitDelay: '<S40>/Delay Input2'
    //
    //  Block description for '<S40>/Delay Input2':
    //
    //   Store in Global RAM
...
void ROPOD_4Wheel_kinb_cntr_terminate(void)
{
  ...
  // Terminate for S-Function (ec_ROPOD_SmartWheel): '<S36>/S-Function'
  // Level2 S-Function Block: '<S36>/S-Function' (ec_ROPOD_SmartWheel)
  {
    SimStruct *rts = ROPOD_4Wheel_kinb_cntr_M->childSfunctions[4];
    sfcnTerminate(rts);
