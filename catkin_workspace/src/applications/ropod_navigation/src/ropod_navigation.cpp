...
ropod_navigation::doorDetection doorStatus;
...
void doorDetectCallback(const ropod_navigation::doorDetection::ConstPtr& DoorStmsg)
{
...
int main(int argc, char** argv) {
    ...
    ros::Subscriber subdoorStatus = n.subscribe<ropod_navigation::doorDetection>("door", 10, doorDetectCallback);
